...
- 独立提交候选门禁：test 78/78，fail/skipped/todo 0；build 14 JS；security 42/0/0；pack 20 文件；diff 检查通过。
...
- PNG 为 296x152 纯黑白、边缘墨点 0、内容无重叠越界；实现提交 `455b033` 的 CI run `30549006691` 已在 Windows、macOS、Ubuntu 全部通过；未 bump/tag/publish，实体屏确认见 BLOCKED.md。
